...
public class Wrapper extends Assert {
    ...
    /**
     * Метод инициализирует все страницы приложения
     */
    ...
    public static void textShouldBeVisible(String text) {
        ...
        assertTrue(element.isDisplayed(), "Текст '" + text + "' должен быть видимым!");
    }
    ...
    public static void elementShouldBeVisible(MobileElement element) {
        ...
        assertTrue(element.isDisplayed(), "Элемент " + element.getText() + " должен быть видимым");
    }
